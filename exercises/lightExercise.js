...
cube2.position.set(4, 0.5,-3);

let cilinder1 = new THREE.Mesh( new THREE.CylinderGeometry( 0.5, 0.5, 3.5), setDefaultMaterial("yellow") );
cilinder1.position.set(2, 2, -2);

let cilinder2 = new THREE.Mesh( new THREE.CylinderGeometry( 0.5, 0.5, 3.5), setDefaultMaterial("blue") );
cilinder2.position.set(-4, 2, 2);
